...
def admin_only(func):
    # The @wraps decorator is a convenience decorator provided by the functools module that is used to
    # update the metadata of a wrapper function to match the metadata of the original wrapped function
    @wraps(func)
